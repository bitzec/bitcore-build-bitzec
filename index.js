...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-bitzec/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-bitzec -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-bitzec -o bitcore-lib-bitzec.js';
    }
